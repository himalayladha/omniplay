...
export default async function NewGamesPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-[#002b50] mb-2">Newest Games</h1>
        <p className="text-sm text-gray-500 font-medium">Play the latest and hottest games added to OmniPlay.</p>
      </div>
